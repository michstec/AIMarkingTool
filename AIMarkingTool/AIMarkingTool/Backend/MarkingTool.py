...
class Semantics:
    ...
    '''This function looks at the instance of a word, determines its pos tag and applies Michael Lesk disambiguition algorithm 
    which determines the word sense of the given word'''
    ...
    if posGroup == NOUNS or posGroup == VERBS:
        ...
        for word_A in sentence1:
            ...
            for word_B in sentence2:
                similarity = wn.path_similarity(word_A.wordSense,
                                                word_B.wordSense)  # a path similarity is measure for 2 word senses
